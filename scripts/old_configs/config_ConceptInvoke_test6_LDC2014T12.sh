...
export MODEL_DIR="${JAMR_HOME}/models/ConceptInvoke_test6_LDC2014T12"  # ideally keep this the same as the config_SOMETHING.sh
...
export PARSER_OPTIONS="
    ...
    --stage2-decoder LR
    --stage2-features rootConcept,rootDependencyPathv1,bias,self,fragHead,edgeCount,distance,logDistance,posPathv3,dependencyPathv4,conceptBigram
