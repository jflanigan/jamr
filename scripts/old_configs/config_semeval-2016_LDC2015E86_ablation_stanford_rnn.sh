...
export TRAIN_FILE="${JAMR_HOME}/data/LDC2015E86_DEFT_Phase_2_AMR_Annotation_R1_stanford_PCFG/data/amrs/split/training/training.txt"
export DEV_FILE="${JAMR_HOME}/data/LDC2015E86_DEFT_Phase_2_AMR_Annotation_R1_stanford_PCFG/data/amrs/split/dev/dev.txt"
export TEST_FILE="${JAMR_HOME}/data/LDC2015E86_DEFT_Phase_2_AMR_Annotation_R1_stanford_PCFG/data/amrs/split/test/test.txt"

export MODEL_DIR="${JAMR_HOME}/models/semeval-2016_LDC2015E86_ablation_stanford_rnn"  # ideally keep this the same as the config_SOMETHING.sh
