...
export MODEL_DIR="${JAMR_HOME}/models/INFRamp_LDC2013E117_alg2_oracle"  # ideally keep this the same as the config_SOMETHING.sh
...
export RELATION_ID_TRAINING_OPTIONS="
    --training-stage2-oracle-decoder Alg2
