...
export TRAIN_FILE="${JAMR_HOME}/data/amr_anno_1.0_no_MT09/data/split/training/training.txt"
export DEV_FILE="${JAMR_HOME}/data/amr_anno_1.0_no_MT09/data/split/dev/dev.txt"
export TEST_FILE="${JAMR_HOME}/data/amr_anno_1.0_no_MT09/data/split/test/test.txt"

export MODEL_DIR="${JAMR_HOME}/models/amr_anno_1.0-NAACL2016-nohandwritten"  # ideally keep this the same as the config_SOMETHING.sh
