...
export MODEL_DIR="${JAMR_HOME}/models/ConceptInvoke_test2_LDC2014T12"  # ideally keep this the same as the config_SOMETHING.sh
...
export STAGE1_FEATURES="bias,length,fromNERTagger,conceptGivenPhrase,count,phraseGivenConcept,phraseConceptPair"
