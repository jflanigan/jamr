...
export MODEL_DIR="${JAMR_HOME}/models/ConceptInvoke_test5_LDC2014T12"  # ideally keep this the same as the config_SOMETHING.sh
...
export RELATION_ID_TRAINING_OPTIONS="
    --stage2-train-with-predicted-concepts
    --training-loss Infinite_Ramp
    --training-optimizer Adagrad
    --training-passes 5
    --training-save-interval 1
