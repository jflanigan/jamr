...
object ExtractSentenceRules {
    ...
    def main(args: Array[String]) {
        ...
        var i = 0
        case class Rule(args: String, realization: List[(Symbol, String, Option[Int], String)], words: String, pos: String)
        val rules : Map[String, (Rule, Int)] = Map() // Map from concept to rule
    ...
    def extractRules(graph: Graph, node: Node, sent: Array[String], pos : Array[String], spans: Map[String, (Option[Int], Option[Int])], spanArray: Array[Boolean], rules : Map[String, Rule]) {
