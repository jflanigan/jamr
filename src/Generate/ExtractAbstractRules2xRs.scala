...
object ExtractAbstractRules2xRs {

    val usage = """Usage: scala -classpath . edu.cmu.lti.nlp.amr.Generate.ExtractAbstractRulesxRs --dependencies deps_file < amr_file > outfile"""
